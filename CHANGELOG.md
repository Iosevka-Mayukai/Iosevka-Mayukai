...
- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 27.3.3 release. Check more changelog about base Iosevka Font 27.3.3 [release note](https://github.com/be5invis/Iosevka/releases/tag/v27.3.3).
...
- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 24.1.1 release. Check more changelog about base Iosevka Font 24.1.1 [release note](https://github.com/be5invis/Iosevka/releases/tag/v24.1.1).
...
- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 22.1.0 release. Check more changelog about base Iosevka Font 22.1.0 [release note](https://github.com/be5invis/Iosevka/releases/tag/v22.1.0).
...
- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 21.1.1 release. Check more changelog about base Iosevka Font 21.1.1 [release note](https://github.com/be5invis/Iosevka/releases/tag/v21.1.1).
...
- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 17.1.0 release. Check more changelog about base Iosevka Font 17.1.0 [release note](https://github.com/be5invis/Iosevka/releases/tag/v17.1.0).

## [6.0.0 - 01012023]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 17.0.2 release. Check more changelog about base Iosevka Font 17.0.2 [release note](https://github.com/be5invis/Iosevka/releases/tag/v17.0.2).

## [5.9.6 - 23122022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 16.8.4 release. Check more changelog about base Iosevka Font 16.8.4 [release note](https://github.com/be5invis/Iosevka/releases/tag/v16.8.4).

## [5.9.5 - 08122022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 16.6.0 release. Check more changelog about base Iosevka Font 16.6.0 [release note](https://github.com/be5invis/Iosevka/releases/tag/v16.6.0).

## [5.9.4 - 21112022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 16.3.6 release. Check more changelog about base Iosevka Font 16.3.6 [release note](https://github.com/be5invis/Iosevka/releases/tag/v16.3.6).

## [5.9.3 - 17102022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 16.3.4 release. Check more changelog about base Iosevka Font 16.3.4 [release note](https://github.com/be5invis/Iosevka/releases/tag/v16.3.4).

## [5.9.2 - 09102022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 16.3.0 release. Check more changelog about base Iosevka Font 16.3.0 [release note](https://github.com/be5invis/Iosevka/releases/tag/v16.3.0).

## [5.9.1 - 19092022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 16.2.0 release. Check more changelog about base Iosevka Font 16.2.0 [release note](https://github.com/be5invis/Iosevka/releases/tag/v16.2.0).

## [5.9.0 - 28082022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 16.0.1 release. Check more changelog about base Iosevka Font 16.0.1 [release note](https://github.com/be5invis/Iosevka/releases/tag/v16.0.1).

## [5.8.8 - 01082022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 15.6.2 release. Check more changelog about base Iosevka Font 15.6.2 [release note](https://github.com/be5invis/Iosevka/releases/tag/v15.6.2).

## [5.8.7 - 27062022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 15.5.2 release. Check more changelog about base Iosevka Font 15.5.2 [release note](https://github.com/be5invis/Iosevka/releases/tag/v15.5.2).

## [5.8.6 - 16052022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 15.5.0 release. Check more changelog about base Iosevka Font 15.5.0 [release note](https://github.com/be5invis/Iosevka/releases/tag/v15.5.0).
...
- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 15.1.0 release. Check more changelog about base Iosevka Font 15.1.0 [release note](https://github.com/be5invis/Iosevka/releases/tag/v15.1.0).

## [5.8.3 - 03032022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 15.0.1 release. Check more changelog about base Iosevka Font 15.0.1 [release note](https://github.com/be5invis/Iosevka/releases/tag/v15.0.1).

## [5.8.2 - 19022022]

- Bug fix and maintenance update from upstream repository.
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 13.3.1 release. Check more changelog about base Iosevka Font 13.3.1 [release note](https://github.com/be5invis/Iosevka/releases/tag/v13.3.1).
...
- For better readibility, we suggest to use Medium (weight 500) and Semibold (weight 600) variant.
- Built with font based on Iosevka Font 11.2.6 release. Check more changelog about base [Iosevka Font 11.2.6 release note](https://github.com/be5invis/Iosevka/releases/tag/v11.2.6).
